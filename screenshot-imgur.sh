...
imgur_acct_key="27af3f1aeddeeb2"
imgur_secret="de64bd58670c740a276e7965e8a0fcbeda4318dc"
login="true"
album_title=""
album_id=""
...
function notify() {
  if is_mac; then
    ...
    if [ "${1}" = "error" ]; then
      notify-send -i "${imgur_icon_path}" -a ImgurScreenshot -u critical -c "im.error" -i "${imgur_icon_path}" -t 500 "imgur: ${2}" "${3}"
    else
